            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text('흡연', style: TextStyle(fontSize: 15,),),),
                  ),
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text('비흡연', style: TextStyle(fontSize: 15, ),),),
                  ),
                  ],
                ),
                SizedBox(height: 35,),
                Padding(
                  ...
                  child: Text('mbti', style: TextStyle(fontSize: 18, color: Color.fromARGB(255, 54, 54, 58),fontWeight: FontWeight.bold),),
                ),
                SizedBox(height: 15,),
                Padding(
                ...
                SizedBox(height: 25,),
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                            ...
                            child: const Text("홈 화면으로 이동", style: TextStyle(fontSize:18, fontWeight: FontWeight.bold ,color:Color.fromARGB(255, 234, 234, 236)),),),
                  ),
              ],
            ),
          ),
